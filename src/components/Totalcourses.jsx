...
const Totalcourses = ({className = "", ...props}) => {
  return (
    <div className = {cn("rounded-2xl bg-white p-4 shadow-sm flex flex-col h-72 dark:bg-stone-900", className)} {...props}>
      <h1 className ="text-lg font-bold text-stone-500 dark:text-white">Total Courses</h1>
      ...
      <div className = "flex flex-row flex-1 pt-3">
        <p className ="text-xl font-bold text-stone-600 dark:text-white">2k+</p>
