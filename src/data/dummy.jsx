...
import { FiShoppingBag, FiEdit, FiPieChart, FiBarChart, FiCreditCard, FiStar, FiHome, FiShoppingCart, } from 'react-icons/fi';
...
import googleico from './icons8-google-meet-48.png'
import teamsico from './icons8-microsoft-teams-2019-50.png'
import skypeico from './icons8-skype-48.png'
...
export const Message = 
  [
    {
      id: 1,
      name: 'David',
      messages: ['Project Alpha is on track for completion next week.'],
      image: David,
    },
    {
      id: 2,
      name: 'Emily',
      messages: ['Project Beta requires additional resources for timely delivery.'],
      image: Emily,
    },
    {
      id: 3,
      name: 'Jennifer',
      messages: ['Project Gamma review scheduled for Friday.'],
      image: Jennifer,
    },
    {
      id: 4,
      name: 'Micheal',
      messages: ['Project Delta has received positive client feedback.'],
      image: Micheal,
    },
    {
      id: 5,
      name: 'Samantha',
      messages: ['Project Epsilon documentation is being finalized.'],
      image: Samantha,
    },
    {
      id: 6,
      name: 'David',
      messages: ['Team meeting rescheduled to Monday at 10 AM.'],
      image: David,
    }
  ]
  ...
  { day: 'Monday', income: 40, total: 10 },
  { day: 'Tuesday', income: 20  , total: 25 },
  { day: 'Wednesday', income: 42, total: 15 },
  { day: 'Thursday', income: 25, total: 35 },
  { day: 'Friday', income: 45, total: 20 },
  { day: 'Saturday', income: 25, total: 45 },
  { day: 'Sunday', income: 32, total: 38 },
];

export const icons = [googleico, teamsico, skypeico]

export const initialMeetings = [
  { id: '1', name: 'Wilson Terry', time: '2:45 AM', description: 'Product Demo and Review' },
  { id: '2', name: 'Jim Kramer', time: '11:30 AM', description: 'Client Feedback Session' },
  { id: '3', name: 'Zack Padilla', time: '1:00 AM', description: 'Problem-Solving Brainstorm' },
  { id: '4', name: 'Layla Garcia', time: '10:00 AM', description: 'Weekly Progress Update' },
...
export const sampleProjects = [
  ...
  },
  {
    ...
    status: 'Completed',
    type: 'Training',
    team: [Samantha, Samantha, Micheal],
